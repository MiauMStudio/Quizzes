...
//        let answer1_3 = "11"
        ...
        let question3 = "小白：\n原来有这么多编程语言啊。那为什么我们要学习Python呢？\n小橘：\nPython本身有许多优势，比如它简单易学、功能强大、语法简洁、支持动态输入、完全免费开源。它是解释型语言，Python程序不需要被编译成二进制代码，非常易于移植；它有着丰富的库（libraries）……\n小白：\n啊……好复杂啊，听不懂🥺。\n小橘：\n不要担心，你很快就能充分体会到Python的优势了。现在，让我们看几个具体的例子，感受下Python的魅力吧！\n首先，请跟我来到Python之家\nhttps://www.python.org\n哦，不，不要用手机，你需要一台电脑来更好地练习。\n小白：好吧，现在我进入了Python主页。唉，为什么全是英文啊。\n小橘：\n没关系，我会一步步教你。可是作为一个程序员，可必须要懂英语啊。\n看到菜单栏下面的代码框了吗？\n小白：\n看到了！它的右上角还有一个黄色按钮，写着“>_”。\n小橘L：\n非常棒，现在，把鼠标移到黄色按钮上。\n小白：\nEmmm，它显示“Launch Interactive Shell”。\n小橘：\n点击黄色按钮，你就进入了Python的在线控制台（console）。你可以看到，当前版本是Python 3.7.0。你能看到光标所在的地方，前方有个“>>>”符号，这叫做解释器提示符（Interpreter Prompt），你可以在其后输入内容，控制台会自动输出。比如，输入\n1 + 1\n按下回车，你可以看到控制台输出了\n2\n这就是交互（interactive）模式。\n现在，试着输入\nprint(\"Hello World\")\n小白：\n它打印出了“Hello World”！\n小橘：\n恭喜你，完成了第一个Python程序！现在，你做好准备接受第二个挑战了吗？\n"
        let answer3_1 = "接受挑战！"
        let quiz3 = Question(question: question3, answers: [answer3_1])
        
        questions.append(quiz3)
        
        let question4 = "使用Python3时，下列哪个语句能打印出 Hello World ？\nTips: 当你不确定答案时，可以在Python交互模式下进行试验哦。"
        let answer4_1 = "print \"Hello World\""
        let answer4_2 = "print(\"Hello World\")"
        let answer4_3 = "print(Hello World)"
        let quiz4 = Question(question: question4, answers: [answer4_1, answer4_2, answer4_3], rightAnswer: answer4_2)
